...
const NAV_ITEMS = [
    {
        ...
        items: [
            ...
            { href: "/dashboard/kalender", label: "Kalender Operasional", module: "any", icon: CalendarIcon },
        ],
    },
    {
        section: "Keuangan",
...
const ALUCURV_NAV_ITEMS = [
    {
        ...
        items: [
            ...
            { href: "/dashboard/alucurv/order", label: "Order", icon: CartIcon },
        ],
    },
    {
        section: "Keuangan",
        items: [
            ...
            { href: "/dashboard/alucurv/hpp", label: "Kalkulator HPP", icon: CalculatorIcon },
        ],
    },
    {
        section: "Gudang & Produksi",
        items: [
            ...
            { href: "/dashboard/alucurv/pengadaan", label: "Pengadaan Bahan Baku", icon: ShoppingBagIcon },
            { href: "/dashboard/alucurv/surat-jalan", label: "Surat Jalan", icon: TruckIcon },
            { href: "/dashboard/alucurv/bending", label: "Bending CV Toto", icon: WrenchIcon },
        ],
    },
    {
        section: "SDM",
    ...
    },
    {
        section: "Administrasi",
        items: [
            { href: "/dashboard/alucurv/pengaturan", label: "Pengaturan", icon: SettingsIcon },
        ],
    },
];
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    const containerClass = [
        ...
        activeWorkspace === "alucurv" ? "workspace-alucurv" : "",
    ].filter(Boolean).join(" ");
                    ...
                    <div id="sidebar">
                        <div className="brand">
                            ...
                            <span className="brand-text" style={{ fontSize: "0.95rem" }}>
                                {activeWorkspace === "alucurv" ? "ERP ALUCURV" : "ERP TOTO"}
                            </span>
                        </div>
...
function CalendarIcon({ size = 18 }: { size?: number }) { return ( <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="17" rx="2" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /><path d="M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01" /></svg> ); }
...
function ShoppingBagIcon({ size = 18 }: { size?: number }) { return ( <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z" /><line x1="3" y1="6" x2="21" y2="6" /><path d="M16 10a4 4 0 01-8 0" /></svg> ); }
function WrenchIcon({ size = 18 }: { size?: number }) { return ( <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a4 4 0 10-5.4 5.4L2 19l3 3 7.3-7.3a4 4 0 005.4-5.4l-2.8 2.8-2-2z" /></svg> ); }
function SettingsIcon({ size = 18 }: { size?: number }) { return ( <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 11-2.83 2.83l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 11-2.83-2.83l.06-.06A1.65 1.65 0 004.6 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 112.83-2.83l.06.06A1.65 1.65 0 009 4.6a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09A1.65 1.65 0 0015 4.6a1.65 1.65 0 001.82-.33l.06-.06a2 2 0 112.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z" /></svg> ); }
