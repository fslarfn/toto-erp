...
const usersToCreate = [
    ...
    { username: 'vira', name: 'Vira', role: 'finance_full', password_hash: 'toto123' },
    { username: 'yuni', name: 'Yuni', role: 'barang_full', password_hash: 'toto123' },
...
async function createUsers() {
    console.log('Memulai pembuatan user...');
